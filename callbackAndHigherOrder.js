...
const test = (num1, num2, callback) => callback(num1 * num2)
...
test(4, 3, answer => console.log ('The answer is ' + answer))
...
//   return arr.forEach(cb(element,index), element, index)
...
let addLucky = addingFactory(13)
console.log( addLucky(0))
